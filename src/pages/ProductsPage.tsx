          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="text-slate-400 text-lg leading-[1.7] max-w-2xl">
                Browse manufacturer lines and product names for municipal water and wastewater applications. Additional equipment lines are available in our full catalog.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="bg-slate-900 border-b border-white/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex divide-x divide-white/10">
              {[
                { value: BRAND_PARTNER_COUNT, label: 'Brand Partners' },
        ...
        <section className="py-20 bg-white border-t border-slate-200">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-xs font-bold text-accent uppercase tracking-[0.18em] mb-5">Get Started</p>
              ...
              Looking for a Specific Line or Refurbishment Scope?
            </h2>
            <p className="text-slate-500 text-base leading-relaxed mb-10 max-w-xl mx-auto">
              Not everything is listed here. Contact our team with your specifications and we will align equipment, parts, or refurbishment support with your facility.
            </p>
            <Link
              to="/contact"
